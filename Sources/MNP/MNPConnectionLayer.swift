...
public final class MNPConnectionLayer {
    ...
    private func handleIdle(linkRequest: MNPLinkRequestPacket) throws {
        ...
        guard
            ...
            linkRequest.dataPhaseOptimization.fixedFieldLTAndLAFrames
        else {
        ...
        maxInfoLength = linkRequest.dataPhaseOptimization.maxInfoLength256
            ? 256
    ...
    private func sendLinkResponse(linkRequest: MNPLinkRequestPacket) throws {
        ...
        let linkResponse =
            MNPLinkRequestPacket(framingMode: linkRequest.framingMode,
                                 ...
                                 dataPhaseOptimization: linkRequest.dataPhaseOptimization,
