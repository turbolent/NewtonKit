...
public struct MNPLinkAcknowledgementPacket: MNPPacket {
    ...
    ///
    /// __Receive sequence number (non-optimized data phase)__
    ///
    ...
    ///
    /// __Receive credit number (non-optimized data phase)__
    ///
    ...
    ///
    /// - Parameter data: without header length and type field
    ///
